...
import gui.componentModels.SelectRechnungenTableModel;
...
public class SelectRechnungenDialog extends JDialog implements ActionListener {
	private JButton save, cancel;
	private JTable table;
	private JScrollPane scrollpane;
	private SelectRechnungenTableModel tModel;
	private TableRowSorter<TableModel> tSorter;

	private Buchungszeile b;

	public SelectRechnungenDialog(JFrame owner, Buchungszeile b) {
	...
	public void initTable() {
		...
		tModel = new SelectRechnungenTableModel(b.getBuchungszeileID());
